      ...
      <div className="container py-16">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-4xl font-bold mb-6">
            Расширение творческих возможностей через ИИ
          </h1>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
            Мы находимся на миссии демократизации создания мемов, делая профессиональную генерацию изображений с помощью ИИ доступной для всех, везде. Присоединяйтесь к миллионам творцов, которые уже превращают свои идеи в вирусный контент.
          </p>
        </div>
        ...
        <div className="text-center">
          <Card className="bg-gradient-to-r from-purple-500 to-pink-500 text-white">
            <CardContent className="p-12">
              <h2 className="text-3xl font-bold mb-4">Готовы начать творить?</h2>
              <p className="text-xl mb-8 text-purple-100">
                Присоединяйтесь к тысячам творцов, которые уже создают вирусный контент с Sybau Picture.
              </p>
