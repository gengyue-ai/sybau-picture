...
import { ArrowLeft, ArrowRight, Search, Filter, Heart, Share2, Download, Eye, Calendar, Loader2, Rocket } from 'lucide-react'
...
export default function ARGalleryPage() {
  ...
  // النصوص الثابتة باللغة العربية
  const staticTexts = {
    title: 'معرض سيباو بيكتشر',
    subtitle: 'اكتشف آلاف الإبداعات من سيباو بيكتشر من المبدعين الموهوبين حول العالم',
    searchPlaceholder: 'البحث عن إبداعات سيباو بيكتشر بواسطة الفئة أو الأسلوب أو المبدع...',
    backToHome: 'العودة للصفحة الرئيسية',
    allCategories: 'جميع الفئات',
    noImagesFound: 'لم يتم العثور على صور',
    noImagesDescription: 'جرب كلمات بحث مختلفة أو تصفح جميع الفئات.',
    viewImage: 'عرض الصورة',
    downloadImage: 'تحميل الصورة',
    shareImage: 'مشاركة',
    byCreator: 'بواسطة',
    stats: {
      totalImages: 'صور سيباو بيكتشر',
      totalCreators: 'مبدعين نشطين',
      totalDownloads: 'إجمالي التحميلات',
      averageRating: 'متوسط التقييم'
    },
    ctaTitle: 'أنشئ صور سيباو بيكتشر الخاصة بك',
    ctaDescription: 'انضم إلى آلاف المبدعين الذين يحققون النجاح مع سيباو بيكتشر.',
  ...
  // بيانات الصور التجريبية
  const mockImages: GalleryImage[] = [
    {
      id: '1',
      title: 'قطة راقصة فيروسية سيباو',
      description: 'إبداع سيباو بيكتشر مضحك انتشر بشكل فيروسي مع أكثر من 2 مليون مشاهدة',
    ...
    {
      id: '2',
      title: 'اجتماع عمل ملحمي',
      description: 'سيباو بيكتشر مثالية لتمثيل فوضى الاجتماعات الحديثة',
      imageUrl: '/api/placeholder/400/300',
      creator: 'فاطمة المصممة',
      category: 'عمل',
    ...
    },
    {
      id: '3',
      title: 'حياة الطالب',
      description: 'واقع طلاب الجامعة في سيباو بيكتشر',
      imageUrl: '/api/placeholder/400/300',
      creator: 'محمد الميمز',
      category: 'تعليم',
    ...
    {
      id: '4',
      title: 'بيتزا مقابل الحمية',
      description: 'المعضلة الغذائية الأبدية موضحة في سيباو بيكتشر',
      imageUrl: '/api/placeholder/400/300',
      creator: 'سارة الفكاهة',
      category: 'طعام',
    ...
    {
      id: '5',
      title: 'نهاية الأسبوع مقابل الاثنين',
      description: 'الانتقال الأكثر رعباً في الأسبوع في سيباو بيكتشر',
      imageUrl: '/api/placeholder/400/300',
      creator: 'خالد المرح',
      category: 'حياة',
    ...
    {
      id: '6',
      title: 'مطور يصحح الأخطاء',
      description: 'حياة المبرمج في سيباو بيكتشر',
      imageUrl: '/api/placeholder/400/300',
      creator: 'عمر التقني',
      category: 'تكنولوجيا',
          ...
          <div className="max-w-2xl mx-auto">
            <div className="relative">
              ...
              <Input
                ...
                className="pr-10 py-3 text-lg bg-white/10 border-white/20 text-white placeholder-white/60 focus:bg-white/20 focus:border-white/40 text-right"
              />
            </div>
          </div>
        </div>
