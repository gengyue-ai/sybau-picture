...
export default function PTGalleryPage() {
  ...
  const staticTexts = {
    title: 'Galeria Sybau Picture',
    subtitle: 'Descubra milhares de criações Sybau Picture de criadores talentosos ao redor do mundo',
    searchPlaceholder: 'Buscar criações Sybau Picture por categoria, estilo ou criador...',
    backToHome: 'Voltar ao início',
    allCategories: 'Todas as categorias',
    noImagesFound: 'Nenhuma imagem encontrada',
    noImagesDescription: 'Tente diferentes termos de busca ou navegue por todas as categorias.',
    viewImage: 'Ver imagem',
    downloadImage: 'Baixar imagem',
    shareImage: 'Compartilhar',
    byCreator: 'Por',
    stats: {
      totalImages: 'Imagens Sybau Picture',
      totalCreators: 'Criadores ativos',
      totalDownloads: 'Downloads totais',
      averageRating: 'Avaliação média'
    },
    ctaTitle: 'Crie suas próprias Sybau Pictures',
    ctaDescription: 'Junte-se a milhares de criadores que estão fazendo sucesso com Sybau Pictures.',
  ...
  // Dados de imagem mock
  const mockImages: GalleryImage[] = [
    {
      id: '1',
      title: 'Gato Dançando Viral Sybau',
      description: 'Uma hilária criação Sybau Picture que viralizou com mais de 2M de visualizações',
      imageUrl: '/api/placeholder/400/300',
      creator: 'CarlosCreativo',
      category: 'Animais',
    ...
    {
      id: '2',
      title: 'Reunião de Trabalho Épica',
      description: 'Sybau Picture perfeita para representar o caos das reuniões modernas',
      imageUrl: '/api/placeholder/400/300',
      creator: 'AnaDesigner',
      category: 'Trabalho',
    ...
    },
    {
      ...
      description: 'A realidade dos estudantes universitários em uma Sybau Picture',
      imageUrl: '/api/placeholder/400/300',
      creator: 'PedroMemes',
      category: 'Educação',
    ...
    {
      id: '4',
      title: 'Pizza vs Dieta',
      description: 'O eterno dilema alimentar retratado em Sybau Picture',
      imageUrl: '/api/placeholder/400/300',
      creator: 'MariaHumor',
      category: 'Comida',
    ...
    {
      id: '5',
      title: 'Fins de Semana vs Segunda-feira',
      description: 'A transição mais temida da semana em Sybau Picture',
      imageUrl: '/api/placeholder/400/300',
      creator: 'JoãoRisadas',
      category: 'Vida',
    ...
    {
      id: '6',
      title: 'Desenvolvedor Debugando',
      description: 'A vida de um programador em uma Sybau Picture',
      imageUrl: '/api/placeholder/400/300',
      creator: 'TechPaulo',
      category: 'Tecnologia',
