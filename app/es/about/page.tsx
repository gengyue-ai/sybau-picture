    ...
    <div className="min-h-screen bg-background">
      <div className="container py-16">
        ...
        <div className="text-center mb-16">
          <Badge className="mb-4">Acerca de Nosotros</Badge>
          <h1 className="text-4xl font-bold mb-6">
            Potenciando la Creatividad a través de la IA
          </h1>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
            Estamos en una misión de democratizar la creación de memes, haciendo que la generación profesional de imágenes con IA sea accesible para todos, en todas partes. Únete a millones de creadores que ya están transformando sus ideas en contenido viral.
          </p>
        </div>
        ...
        <div className="text-center">
          <Card className="bg-gradient-to-r from-purple-500 to-pink-500 text-white">
            <CardContent className="p-12">
              <h2 className="text-3xl font-bold mb-4">¿Listo para Empezar a Crear?</h2>
              <p className="text-xl mb-8 text-purple-100">
                Únete a miles de creadores que ya están haciendo contenido viral con Sybau Picture.
              </p>
